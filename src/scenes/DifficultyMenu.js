...
export default class DifficultyMenu extends Phaser.Scene {
    ...
    create() {
        ...
        if (this.components !== null) {
            ...
            this.images.normal = {};
            this.texts["normal"] = {};
            this.images["normal"]["acrylicStrips"] = this.add.image(
                (515 / 1368) * 800,
                (600 / 769) * 500,
                "acrylicStrips"
            );
            this.images.normal.acrylicStrips.setScale(0.075);
            this.texts["normal"]["acrylicStrips"] = this.add.text(
                (565 / 1368) * 800,
                (580 / 769) * 500,
            ...
            this.images["normal"]["drilledWood"] = this.add.image(
                (515 / 1368) * 800,
                (660 / 769) * 500,
                "drilledWood"
            );
            this.images.normal.drilledWood.setScale(0.075);
            this.texts["normal"]["drilledWood"] = this.add.text(
                (565 / 1368) * 800,
                (640 / 769) * 500,
                this.components.drilledWood + "/" + DRL_WOD_MAX,
                DifficultyMenu.textDefaultConfig
