...
export default class GameUI extends Phaser.Scene {
    ...
    create() {
        ...
        this.renderScore();
        if (this.isMobile) this.renderPickButton();
    }
    ...
    renderPickButton() {
        ...
        var y = 400;
        this.buttons = {};
        this.buttons["mPickBtn"] = new Button(
            this,
            x,
            y,
            "mPickBtn",
    ...
    renderClock() {
        ...
        let clockLayer = this.scene.scene.add.layer([
            this.scene.scene.children.getByName("clockbg"),
        ]);
    ...
    renderCurrentItem() {
        ...
        bubble.setScale(0.3);
        let bubbleLayer = this.scene.scene.add.layer([
            this.scene.scene.children.getByName("bubble"),
        ]);
